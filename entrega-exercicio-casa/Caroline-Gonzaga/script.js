    ...
    selectCountry.addEventListener('change', function(event) {
      ...
      if (countryValue === 'br') {
        ...
        selectCity.addEventListener('change', function(event) {
          ...
          if (cityValue === 'cxs') {
            displayText.innerHTML = 'Vai ganhar uma camiseta branca'; 
          } else if (cityValue === 'poa') {
            displayText.innerHTML = 'Vai ganhar uma camiseta azul';
          } else if (cityValue === 'default') {
            displayText.innerHTML = ""
    
          } else {
            displayText.innerHTML = 'Vai ganhar uma camiseta amarela';
          }
        });
        ...
        displayText.innerHTML = 'Vai ganhar uma camiseta verde';
    
      } else if (countryValue === 'eua') {
        cityFieldset.classList.add('hidden');
        displayText.innerHTML = 'Vai ganhar uma camiseta roxa'
        ...
        cityFieldset.classList.add('hidden');
        displayText.innerHTML = 'Vai ganhar uma camiseta preta'
      };
